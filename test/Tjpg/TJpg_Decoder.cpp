...
// //--modificado para centrar imagenes, javier
// ***************************************************************************************/
// JRESULT TJpg_Decoder::drawJpg(int32_t x, int32_t y, const uint8_t jpeg_data[], uint32_t data_size, uint16_t tft_width, uint16_t tft_height)
// {
//   JDEC jdec;
//   JRESULT jresult = JDR_OK;
...
//   /***** Muestra la imagen centrada, si x o y son < 0,  Javier. ****/
//   if (jresult == JDR_OK && x < 0)
//     jpeg_x = (tft_width - jdec.width) / 2;
//   if (jresult == JDR_OK && y < 0)
//     jpeg_y = (tft_height - jdec.height) / 2;
